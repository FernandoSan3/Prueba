...
a persistence unit "PruebaADPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PruebaAD\pom.xml":
...
artifact ("PruebaAD.war") is already built. You can build
